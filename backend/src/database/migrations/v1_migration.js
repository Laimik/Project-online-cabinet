const migrateToV1 = async () => {
    ...
    await pool.execute("create table IF NOT EXISTS rate (id int auto_increment primary key, rate float not null, counter_type_id int not null, date_begin date not null);");
